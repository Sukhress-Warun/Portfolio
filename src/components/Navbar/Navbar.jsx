...
const Navbar = () => {
    ...
    const [hoverSound] = useSound('/sounds/hover.wav', {playbackRate: 2, volume: 0.5})
    const [hoverReverseSound] = useSound('/sounds/hover-reverse.wav', {playbackRate: 2, volume: 0.5})
